...
static int ngx_tcp_lua_ngx_cookie_time(lua_State *L);
static int ngx_tcp_lua_ngx_http_time(lua_State *L);
static int ngx_tcp_lua_ngx_parse_http_time(lua_State *L);
...
static int
ngx_tcp_lua_ngx_cookie_time(lua_State *L)
{
    time_t                               t;
    u_char                              *p;
...
static int
ngx_tcp_lua_ngx_http_time(lua_State *L)
{
    time_t                               t;
    u_char                              *p;
...
static int
ngx_tcp_lua_ngx_parse_http_time(lua_State *L)
{
    u_char                              *p;
    size_t                               len;
    time_t                               time;
...
ngx_tcp_lua_inject_time_api(lua_State *L)
{
    ...
    lua_pushcfunction(L, ngx_tcp_lua_ngx_cookie_time);
    lua_setfield(L, -2, "cookie_time");

    lua_pushcfunction(L, ngx_tcp_lua_ngx_http_time);
    lua_setfield(L, -2, "http_time");

	lua_pushcfunction(L, ngx_tcp_lua_ngx_parse_http_time);
