...
static int ngx_tcp_lua_ngx_localtime(lua_State *L);
static int ngx_tcp_lua_ngx_utctime(lua_State *L);
static int ngx_tcp_lua_ngx_tcp_time(lua_State *L);
static int ngx_tcp_lua_ngx_parse_tcp_time(lua_State *L);
static int ngx_tcp_lua_ngx_update_time(lua_State *L);
static int ngx_tcp_lua_ngx_req_start_time(lua_State *L);


static int
ngx_tcp_lua_ngx_today(lua_State *L)
{
    time_t                   now;
    ngx_tm_t                 tm;
...
static int
ngx_tcp_lua_ngx_localtime(lua_State *L)
{
    ngx_tm_t                 tm;
...
static int
ngx_tcp_lua_ngx_time(lua_State *L)
{
...
static int
ngx_tcp_lua_ngx_update_time(lua_State *L)
{
    ngx_time_update();
    return 0;
}
...
static int
ngx_tcp_lua_ngx_utctime(lua_State *L)
{
    ngx_tm_t       tm;
    u_char         buf[sizeof("2010-11-19 20:56:31") - 1];
...
static int
ngx_tcp_lua_ngx_tcp_time(lua_State *L)
{
    time_t                               t;
    u_char                              *p;
...
static int
ngx_tcp_lua_ngx_req_start_time(lua_State *L)
{
    ngx_tcp_session_t  *r;
...
void
ngx_tcp_lua_inject_time_api(lua_State *L)
{
    lua_pushcfunction(L, ngx_tcp_lua_ngx_utctime);
    lua_setfield(L, -2, "utctime");

    lua_pushcfunction(L, ngx_tcp_lua_ngx_time);
    lua_setfield(L, -2, "get_now_ts"); /* deprecated */

    lua_pushcfunction(L, ngx_tcp_lua_ngx_localtime);
    ...
    lua_pushcfunction(L, ngx_tcp_lua_ngx_now);
    lua_setfield(L, -2, "now");

    lua_pushcfunction(L, ngx_tcp_lua_ngx_update_time);
    lua_setfield(L, -2, "update_time");

    lua_pushcfunction(L, ngx_tcp_lua_ngx_today);
    lua_setfield(L, -2, "get_today"); /* deprecated */

    lua_pushcfunction(L, ngx_tcp_lua_ngx_today);
    lua_setfield(L, -2, "today");

    lua_pushcfunction(L, ngx_tcp_lua_ngx_tcp_time);
    lua_setfield(L, -2, "tcp_time");

    lua_pushcfunction(L, ngx_tcp_lua_ngx_parse_tcp_time);
    lua_setfield(L, -2, "parse_tcp_time");
}


void
ngx_tcp_lua_inject_req_time_api(lua_State *L)
{
    lua_pushcfunction(L, ngx_tcp_lua_ngx_req_start_time);
